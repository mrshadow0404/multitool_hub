...
root = Tk()
root.title("Multi Tool Hub")
root.geometry("850x500+300+170")
root.resizable(False,False)
root.configure(bg="#292e2e")

#icon
img_icon = PhotoImage(file="Image/icon.png")
...
def weather():
    ...
    def getWeather():
        try:
            ...
            obj= TimezoneFinder()
            result=obj.timezone_at(lng=location.longituse,lat=location.latitude)
            ...
            #weather
            api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=098422e13a1f59216ba2a1190a209371"
    ...
    myimage_icon=Button(app1,image=Search_icon,borderwidth=0,cursor="hand2",bg="#040404",command=getWeather)
